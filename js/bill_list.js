...
class card {
    ...
    create() {
        ...
        var catandtime_icon = $("<div class='bill-icon pr-2'></div>").html(iconSelector(this.mainCategory,global.dataJson.mainCategories));
        ...
        var text_date = $("<div class='bill-date text-center p-0'></div>").html("<strong>"+this.time.getDate() +"</strong>"+ "日<br>" + "<small class='text-muted' hidden>"+(this.time.getMonth() + 1)+"月</small>");
